...
function getWeatherData(city, unit, hourlyorWeek) {
  fetch(
    `https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/${city}?unitGroup=metric&key=MP68T99VLPMN2LNHXK63YCBEY&contentType=json`,
    {
      method: "GET",
      headers: {},
    }
    ...
    .catch((err) => {
      alert("City not selected or not found in the database");
    });
}
...
function updateAirQualityStatus(airquality) {
  if (airquality <= 50) {
    airQualityStatus.innerText = "Air Quality is good";
  } else if (airquality <= 100) {
    airQualityStatus.innerText = "Air Quality is moderate";
  } else if (airquality <= 150) {
    airQualityStatus.innerText = "Air Quality is Unhealthy for Sensitive Groups";
  } else if (airquality <= 200) {
    airQualityStatus.innerText = "Air Quality is Unhealthy";
  } else if (airquality <= 250) {
    airQualityStatus.innerText = "Air Quality is Very Unhealthy";
  } else {
    airQualityStatus.innerText = "Air Quality is Hazardous";
  }
}
